...
<link rel="stylesheet" href='<?php echo e(url("css/login.css")); ?>'/>
        ...
        <form class="row" name="login" method='post'>
             ...
             <div class="colm-form">
                 ...
                 <p class='descr'>Accedi o Registrati subito a Music Store, che ti permetterà di creare la playlist che si adatta di più a te e restare sempre aggiornato sulle utlime news musicali</p>
                     <p class="scritta">Se già hai un account, <a href='<?php echo e(url("login")); ?>'>accedi</a> </p>
    ...
    </html><?php /**PATH C:\xampp\htdocs\hw2\resources\views/descrizione.blade.php ENDPATH**/ ?>